...
class Plain
{
    ...
    {
        add_filter('f!Dplugins\\PlainClasses\\Core\\Plain::tribute_autocomplete', [$this, 'builtin_integration'], 10);
        add_filter('f!Dplugins\\PlainClasses\\Core\\Plain::tribute_autocomplete', fn ($classes) => array_unique($classes), 100001);
    ...
    public function oxygen_enqueue_ui_scripts()
    {
        ...
        $autocomplete = apply_filters('f!Dplugins\\PlainClasses\\Core\\Plain::tribute_autocomplete', $autocomplete);
        ...
        wp_localize_script(self::OPTION_NAMESPACE . '-editor', 'dplugins_plain_classes_tribute', [
