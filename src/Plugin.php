...
final class Plugin
{
    ...
    public const WP_OPTION_NAMESPACE = 'dplugins_plain_classes';
    ...
    {
        $this->templates = new Engine(dirname(DPlUGINS_PLAIN_CLASSES_FILE) . '/templates');
    }
    ...
    public function boot()
    {
        ...
        add_filter('f!Dplugins\\PlainClasses::get_instance', fn ($_) => \Dplugins\PlainClasses\Plugin::get_instance());
    }
    ...
    {
        do_action('a!Dplugins\\PlainClasses\\Plugins::activate_plugin_start');
        // TODO: Add activation logic here.
        do_action('a!Dplugins\\PlainClasses\\Plugins::activate_plugin_end');
    }
    ...
    {
        do_action('a!Dplugins\\PlainClasses\\Plugins::deactivate_plugin_start');
        // TODO: Add deactivation logic here.
        do_action('a!Dplugins\\PlainClasses\\Plugins::deactivate_plugin_end');
    }
    ...
    public function plugin_data($key = null)
    {
        ...
        if (!$plugin_data) {
            $plugin_data = get_plugin_data(DPlUGINS_PLAIN_CLASSES_FILE);
    ...
    public function plugin_action_links($links)
    {
        $plugin_shortcuts = [
            ...
            ], admin_url('admin.php')), __('Settings', 'dplugins-plain-classes')),
        ];
