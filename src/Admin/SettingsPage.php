...
class SettingsPage
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_init', function () {
            ...
            if (false === apply_filters('ct_vsb_dplugins_patch', false)) {
    ...
    public function admin_menu()
    {
        if (current_user_can($this->capability)) {
            $hook = add_submenu_page(
                'ct_dashboard_page',
                __('Plain Classes', 'dplugins-plain-classes'),
                __('Plain Classes', 'dplugins-plain-classes'),
                $this->capability,
            ...
            if (defined('ACSS_PLUGIN_FILE') && !defined('ACSS_PURGER_FILE')) {
                add_submenu_page(
                    ...
                    'acss-purger',
                    function () {
                        $location = 'https://rosua.org/downloads/acss-purger/?utm_medium=dplugins-plain-classes-plugin&utm_source=automatic-css-plugin';
                        $safe = false;
                        if (!headers_sent()) {
                            if ($safe) {
        ...
        $this->templates->addData([
            ...
            'tabs' => [
                [
                    ...
                    'title' => __('Settings', 'dplugins-plain-classes'),
                ...
                [
                    ...
                    'title' => __('License', 'dplugins-plain-classes'),
    ...
    public function get_patch_version()
    {
        ...
        return apply_filters('ct_vsb_dplugins_patch', '0.0.0');
    }
