        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <?php endif ?>
                    <p class="description">Enter your <a href="https://dplugins.com/products/dplugins-plain-classes" target="_blank">license key</a> receive the update of the latest version.</p>
